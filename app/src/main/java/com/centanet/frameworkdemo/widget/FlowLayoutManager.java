package com.centanet.frameworkdemo.widget;
...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    private SparseArray<Rect> mRectSparseArray;//key 是View的position，保存View的bounds 和 显示标志，

    public FlowLayoutManager() {
        mRectSparseArray = new SparseArray<>();
    }
        ...
        if (dy >= 0) {
            ...
            for (int i = maxPos; i >= mFirstVisiblePos; i--) {
                ...
                if (rect.bottom - mVerticalOffset - dy < getPaddingTop()) {
                    ...
                    layoutDecoratedWithMargins(child, rect.left, rect.top - mVerticalOffset,
                            rect.right, rect.bottom - mVerticalOffset);
                }
            }
        }
        return dy;
