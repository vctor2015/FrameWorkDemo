 ...
 * 透明状态栏4.4解决方案
 * <p>
 * Created by github on 2016/4/5.
 * <p><a href="https://github.com/fanxin92/TransparentStatusBarSample">github</a>
 */
        ...
        if (!mLayoutReady) {
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT_WATCH) {
                if ((getWindowSystemUiVisibility() &
                    ...
                    try {
                        try {
                            Field mLastInsets = CollapsingToolbarLayout.class.getDeclaredField(
                                    "mLastInsets");
